...
class AuthModel {
    constructor({ db }) {
        this.addUser = (email, name, password) => __awaiter(this, void 0, void 0, function* () {
            try {
                const newUser = {
                    userID: (0, uuid_1.v4)(),
                    email,
                ...
                yield this.db.execute('INSERT INTO users (userID,email,name,password,registerAt) VALUES (:userID,:email,:name,:password,:registerAt)', {
